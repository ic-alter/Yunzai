...
async function getBaseinfo(e){
    ...
    let otherGenderOptions = [/*"男", "女", */"无性", "未知", "不可知", "其他","双性", "流动","直升机","第三性","男娘","拟雌","拟雄","傅首尔","麻辣仙人","龟仙人","去势","胖猫","秀吉","超雄","杨笠","雌雄同体","Null","未定义","随机","未亡人","男爱豆","不便透露","酷儿"]
    let otherRaceOptions = [/*人类,*/"狼兽人","蜥蜴人","机器人","矮人","天使","恶魔","地精","半身人","精灵","人鱼","吸血种","月球人","领域外生命","奇美拉","半人马","幽灵","巨人","伪人","寄生兽","喰种","妖怪","龙族","鬣狗","棘皮动物","裸鼹鼠","克苏鲁","树精","地缚灵","数字生命","仿生人","复制人","高维生物","三体人","人工智能","神灵","南方古猿","海绵","大象","猫兽人","犬兽人","史莱姆","骷髅","鸟人","熔岩人","水精灵","儒艮","蛇妖","雪女","莴苣","海嗣","源石虫","邦布","猪兽人","犀牛兽人","南方古猿","未知","英灵","泰坦","变异人","虎兽人","僵尸","死灵","蜗牛","蜘蛛精","短脖兔","鼠兽人","熊兽人","单眼族","血魔","纸扎人","稻草人","律者","记忆体","貘兽人","猫","大型岛屿","石块","异兽","哥布林","夜叉","皮皮西人","生骸","恐龙","西蓝花","堕天使","味真族","屎壳郎","枫丹人","人偶","豹兽人","抹香鲸","古神","不可名状","蟑螂人","冰激凌机","硅胶模型","面塑人","糖人"]
    let thinkOptions = ["胃袋","赤石","愉悦","偷税","爱","下头","坤","包菜精"]
    let rankOptions = [{
      value: 'F',
      style: "color: #000000;"
      },
