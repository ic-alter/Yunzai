...
/*
item的type：
道具类型包括：重要道具, 特殊道具，交易物品，消耗品-玩家，消耗品-任意玩家，消耗品-孩子
重要道具: 有重要作用的道具，禁止丢弃
...
export const itemInfo = {
    ...
    "名字空了一半的结婚证":{
        type:"交易物品",
        desc:"结婚证上只有一半的名字。下次结婚时无需对方同意即可强制结婚。",
        default_price: 50000
    },
    "不得提出离婚的特定情形认定书":{
        type:"消耗品-其他玩家",
        desc:"一份民政局出具的不得提出离婚的特定情形认定书，使用对象在24小时内无法提出离婚申请",
        default_price: 79999,
        use: {
            target: "any_player",
            afterText:"ta在24小时内无法提出离婚申请",
            effect: {
                state: {
                addTime: {
                    key: "不得提出离婚的特定情形",
    ...
    "准予强制离婚认定书":{
        type:"交易物品",
        desc:"一份民政局出具的准予强制离婚认定书，下次离婚时无需冷静期，且优先级高于“不得提出离婚的特定情形认定书”",
        default_price: 67887
    },
    "硅胶牛牛模型":{
        type:"消耗品-玩家",
